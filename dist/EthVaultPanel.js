...
export function EthVaultPanel({ vaultAddress, chainId = mainnet.id, title = "ETH Bot Vault", className, onSubmitted }) {
    ...
    const status = useMemo(() => {
        ...
        if (vault.isWritePending)
            return "Confirm in wallet";
        if (vault.isConfirming)
