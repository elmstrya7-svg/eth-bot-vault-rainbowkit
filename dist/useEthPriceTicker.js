...
export function useEthPriceTicker(options = {}) {
    ...
    useEffect(() => {
        ...
        function connect() {
            ...
            socket.onmessage = (event) => {
                try {
                    const nextMessage = JSON.parse(String(event.data));
    ...
    return useMemo(() => {
        ...
        const changePercent24h = price !== null && open !== null && Number.isFinite(open) && open > 0 ? ((price - open) / open) * 100 : null;
        return {
...
//# sourceMappingURL=useEthPriceTicker.js.map